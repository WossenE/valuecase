...
# HERE-1
TEMPLATE_DIRS=(".templates/frontend/react" ".templates/frontend/vue" ".templates/frontend/angular")
...
echo ""
echo "Welcome! Please choose a frontend template 🎨"
echo ""
...
echo "––––––––"
echo ""
PS3="Choose a frontend template ($OPTION_MIN - $OPTION_MAX): "

# HERE-2
select template in "React 18 🧪" "Vue 3 👀" "Angular 🛡"
do
